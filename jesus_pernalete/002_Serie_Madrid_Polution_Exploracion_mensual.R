...
polution_ts <- read.csv("C:/TINAMICA/TINAMICA_SPAIN/Laboratorios/Lab_time_series/GitHub_Repositorio/jesus_pernalete/datos/madrid_polution_mes_ts.csv")
typeof(polution_ts)
colnames(polution_ts)

#sERIE PM_CENTRO
polution_ts_pm_centro<-subset(polution_ts, select=c(PM_CENTRO))
polution_ts_pm_centro<-ts(polution_ts_pm_centro$PM_CENTRO, start = c(2010,1), frequency = 12)
